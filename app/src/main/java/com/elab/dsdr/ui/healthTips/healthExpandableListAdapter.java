package com.elab.dsdr.ui.healthTips;
 ...
 */
public class healthExpandableListAdapter extends BaseExpandableListAdapter {
    private Context context;
    private List<String> listDataHeader;

    private HashMap<String, List<String>> listDataChild;

    healthExpandableListAdapter(Context context, List<String> listDataHeader,
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_group_tips, null);

        }

        TextView labelHeader = convertView.findViewById(R.id.labelhead2);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView tChild = convertView.findViewById(R.id.labelitem2);
